    ...
    <>
      ...
      {showLanding && !results ? (
        ...
        <div className="container">
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.background = '#B899D6';
                    e.target.style.color = '#271E37';
                    e.target.style.transform = 'translateY(-2px)';
                    e.target.style.boxShadow = '0 6px 20px rgba(184, 153, 214, 0.4)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.background = '#533F67';
          ...
          <header className="header" style={{ marginTop: '0rem', padding: '0 2rem' }}>
            <h1 className="title">
          ...
          <footer className="footer">
            ...
            <p className="footer-small">
              Powered by AI &amp; Wikipedia • Open Source Project
            </p>
          </footer>
        </div>
      )}
